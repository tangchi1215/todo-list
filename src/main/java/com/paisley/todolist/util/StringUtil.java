...
public final class StringUtil {
    ...
    public static String format(String pattern, Object... params) {
        return String.format(pattern.replace("{}", "%s"), params);
    }
    ...
    public static boolean equalsAnyIgnoreCase(String text1, String... text2) {
        return Arrays.stream(text2).anyMatch(text -> text.equalsIgnoreCase(text1));
    }

    public static boolean equalsAny(String text1, String... text2) {
        return Arrays.asList(text2).contains(text1);
    }

    public static boolean equalsAny(String text1, List<String> text2s) {
    ...
    public static List<String> transToList(String data, String regex) {
        ...
        return Arrays.stream(temp).map(String::trim).collect(Collectors.toList());
    }
